...
public class HillCipher
{
    ...
    public static void HillCipherStart(HashMap<String,User> users,String username) throws Exception
    {
    	HillCipher.users=users;
    	HillCipher.username=username;
        HillCipher obj = new HillCipher();
        System.out.println("IF LENGTH OF LINE IS n THEN KEY LENGTH SHOULD BE nxn");
        ...
        else
        {
            ...
            if (obj.check(key, s))
            {
                ...
                users.get(username).cipherHistory.add("HILL CIPHER : FROM "+line+" TO ");
                obj.divide(line, s);
